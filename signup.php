...
include("header.php");
?>
<div style="background-color:white;margin-right:10%; margin-left:10%;padding-bottom:20px;border-radius:5px;">
 <table width="100%" border="0" >
   <tr>
     <td width="132" rowspan="2" valign="top"><span class="style8"></span></td>
     <td width="468" height="57"><h2 align="center">New User Signup</h2></td>
   </tr>
   <tr>
